...
const STEPS = [
  { num: "1", title: "选片段，建语感", content: "在首页按动画系列或难度筛选你感兴趣的视频。点开一个动画片段，先整体看一遍，感受语境和语速。" },
  { num: "2", title: "精学一个片段", content: "觉得太快就调到 0.75x，打开双语字幕再看一遍。结合词汇卡理解片段里的单词和短语，遇到不认识的词直接点字幕查词，好词收藏到词汇本。" },
    ...
    <div style={{ minHeight: "100vh", background: "#f7f8fd", fontFamily: "system-ui, -apple-system, sans-serif" }}>
      ...
      <div className="guide-mobile">
        <div className="m-hero">
          ...
          <p className="m-hero-desc">精选儿童动画真实英语片段，双语字幕 + 词汇卡，让孩子在真实语境里快乐学英语！</p>
        </div>
